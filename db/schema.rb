...
ActiveRecord::Schema.define(version: 20180708094120) do
  ...
  create_table "favolites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["micropost_id"], name: "index_favolites_on_micropost_id", using: :btree
    t.index ["user_id"], name: "index_favolites_on_user_id", using: :btree
  end
  ...
  add_foreign_key "favolites", "microposts"
